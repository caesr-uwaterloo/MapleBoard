                    ...
                    if( parent->bsp_positive == 0 )
                        {
                            ...
                            foreach_patch_in_bsp( refine_newpatch, (void*)patch, process_id ) ;
                            return ;
                        }
                    else
...
void split_into_3( patch, ev1, ev2, ev3, e12, e23, e31, parent, process_id )
...
void split_into_2( patch, ev1, ev2, ev3, e12, e23, e31, parent, process_id )
