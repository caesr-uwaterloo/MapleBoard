...
import components._
import fixtures.{TargetPlatformMESI => CurrentPlatform}
import org.scalatest.{FlatSpec, Matchers}
import testutil.{RequestManager, RequestSendConfig}

class PipelinedMESIReplacementSpec extends FlatSpec with ChiselScalatestTester with Matchers {
  behavior of "PipelinedMESI"
