...
import components._
import fixtures.TargetPlatformPMSIAtomicModified
import org.scalatest.{FlatSpec, Matchers}
import testutil.{RequestManager, RequestSendConfig}

// This is only for the modified
class PipelinedPMSIAtomicModifiedReplacementSpec extends FlatSpec with ChiselScalatestTester with Matchers {
  behavior of "PipelinedPMSIAtomicModified"
  ...
  val pf = TargetPlatformPMSIAtomicModified
